...
<div className="p-x-2">
    ...
    <Form {...form}>
        ...
        <FormField control={form.control} name="bullying" render={({ field }) => (
            <FormItem>
            <FormLabel>¿Su hijo/a sufre o ha sufrido aislamiento, bullying o  algún tipo de trato que le influya negativamente en el estudio/aprendizaje? *Opcional</FormLabel>
            <FormControl>
                <Textarea {...field} placeholder="Escribe aquí" rows={4} />
            </FormControl>
            <FormMessage />
